...
public:
    ...
    virtual bool GetSigHash(int nHashType, const CScript& scriptCode, SigVersion sigversion, uint256 * sighashOut) 
    {
        return false;
    }
...
public:
    ...
    bool GetSigHash(int nHashType, const CScript& scriptCode, SigVersion sigversion, uint256 * sighashOut);
};
